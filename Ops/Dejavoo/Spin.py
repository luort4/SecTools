...
def steam_automate(driver, df1):
    addUser_url = 'https://dvmms.com/steam/admin.aspx?screen_ID=130&ACTION=ADD&Main_Field=1137&ret=https%3a%2f%2fdvmms.com%2fsteam%2fadmin.aspx%3fScreen_ID%3d101'
    #login and then
...
def ops_onboard(df, df1, driver):
    ...
    for i, j in enumerate(df['Department']):
        if j == "Operations Team" and df['Home Base'][i] == 'Orlando':
            ...
            userName.append(fullName[i] + " SPIN")
...
Here is your access for Dejavoo/DVMSS SPIN:
Username: {j}
